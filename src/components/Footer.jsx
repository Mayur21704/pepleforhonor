    ...
    const footerLinks = [
        {
            title: "Services",
            links: [
                { name: "Employment Support", href: "/programs/empowerment#empowerment" },
                { name: "Mentorship Program", href: "/programs/mentorship#mentorship" },
                { name: "Personal Coaching", href: "/programs/coaching#coaching" },
